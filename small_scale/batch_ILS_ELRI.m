function [i,et,P,reward] = batch_ILS_ELRI(reward_param)
% reward_param = 0.01;
...
%     R_his(i) = reward;
    ...
    % Check convergence
    if abs(reward-R_his(1)) < 0.01 && conv_check == max_wait
        break;
    elseif abs(reward-R_his(1)) < 0.01
